  ...
  <body>
    <div class="email-wrapper">
      ...
      <div class="content">
        ...
        <p class="message">
          We received a request to reset your password. Use the one-time password (OTP) below to verify your identity and proceed with creating a new password.
        </p>

        <div class="otp-container">
          <div class="otp-label">Your Password Reset Code</div>
          <div class="otp-code">${otp}</div>
          <div class="otp-validity">Valid for <strong>5 minutes</strong></div>
        </div>

        <div class="warning-box">
          <p>⚠️ Do not share this OTP with anyone. Our support team will never ask for your password or code.</p>
        </div>
